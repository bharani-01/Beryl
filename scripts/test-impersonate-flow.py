...
local_path = r"d:\syncd\scratch\test_imp_run.php"
...
subprocess.run([
    ...
    local_path, f"{HOST}:/tmp/test_imp_run.php"
], check=True)

cmd = (
    "sudo docker cp /tmp/test_imp_run.php coolify:/var/www/html/test_imp_run.php && "
    "sudo docker exec coolify php /var/www/html/test_imp_run.php && "
    "sudo docker exec coolify rm -f /var/www/html/test_imp_run.php && "
    "rm -f /tmp/test_imp_run.php"
)
