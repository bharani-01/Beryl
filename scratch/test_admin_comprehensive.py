...
with open("scratch/remote_comprehensive_test.php", "w") as f:
    f.write(test_script)

subprocess.run(["scp", "-o", "StrictHostKeyChecking=no", "-i", SSH_KEY, "scratch/remote_comprehensive_test.php", f"{HOST}:/tmp/remote_comprehensive_test.php"], check=True)
res = subprocess.run([
    "ssh", "-o", "StrictHostKeyChecking=no", "-i", SSH_KEY, HOST,
    "sudo docker cp /tmp/remote_comprehensive_test.php coolify:/var/www/html/remote_comprehensive_test.php && sudo docker exec coolify php /var/www/html/remote_comprehensive_test.php && sudo docker exec coolify rm /var/www/html/remote_comprehensive_test.php"
