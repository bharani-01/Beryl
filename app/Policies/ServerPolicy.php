...
class ServerPolicy
{
    ...
    {
        return currentTeam()?->id === 0 && $user->teams->contains('id', $server->team_id);
    }
    ...
    {
        return currentTeam()?->id === 0 && $user->isAdmin();
    }
    ...
    {
        return currentTeam()?->id === 0 && $user->isAdminOfTeam($server->team_id);
    }
