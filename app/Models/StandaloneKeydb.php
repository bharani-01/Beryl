...
use App\Traits\HasPlanResourceLimits;
...
{
    use ClearsGlobalSearchCache, HasDatabaseHealthCheck, HasFactory, HasMetrics, HasPlanResourceLimits, HasSafeStringAttribute, SoftDeletes;
