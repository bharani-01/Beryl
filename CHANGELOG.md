...
- Implement server management, shared variables, and subscription features
- Introduce UI redesign with new Livewire components, views, and branding assets
- Add subscription management, Razorpay billing integration, audit logs, and admin dashboard enhancements
- Add comprehensive forensic audit logging, device tracking, and IP geolocation services
- Add application configuration file and navbar and version view components
